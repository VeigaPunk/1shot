...
- **Independent rendition.** Your whole reference set is this checkpoint, the original games, official production material about them and about the references above, tool and library documentation, and your own knowledge. Do not search for or open other renditions of this project, forks or copies of this repository, `ds4cc.com/magga`, or third-party remakes of these originals. If you stumble on them, close them and say so. End each ship record with a provenance declaration listing what you consulted.
